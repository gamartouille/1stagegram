...
}`)}function t(e){e.uniforms.add(new a("screenSizePerspective",e=>o(e.screenSizePerspective,e.screenSizePerspectiveMinPixelReferenceSize)))}function i(e){e.uniforms.add(new a("screenSizePerspectiveAlignment",e=>o(e.screenSizePerspectiveAlignment||e.screenSizePerspective,e.screenSizePerspectiveAlignment?null:e.screenSizePerspectiveMinPixelReferenceSize)))}function o(r,a){const c=null!=a&&null!=r?Math.min(r.minPixelSize/a,1):0;return r?e(n,r.divisor,r.offset,c):e(n,0,0,0)}const n=r();export{s as ScreenSizePerspective,t as addScreenSizePerspective,i as addScreenSizePerspectiveAlignment};
