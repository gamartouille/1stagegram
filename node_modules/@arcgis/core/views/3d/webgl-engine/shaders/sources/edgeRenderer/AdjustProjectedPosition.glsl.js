...
}`)):(c.uniforms.add(new s("transformNormalViewFromGlobal",o=>o.transformNormalViewFromGlobal),new t("transformProjFromView",o=>o.camera.projectionMatrix)),c.code.add(a`vec2 calculateProjectedBiasXY(vec4 projPos, vec3 globalNormal) {
float offsetXY = depthBias.x;
