...
import{ScreenSpacePass as e}from"../views/3d/webgl-engine/core/shaderLibrary/ScreenSpacePass.glsl.js";import{glsl as o}from"../views/3d/webgl-engine/core/shaderModules/glsl.js";import{Texture2DPassUniform as r}from"../views/3d/webgl-engine/core/shaderModules/Texture2DPassUniform.js";import{ShaderBuilder as t}from"../views/webgl/ShaderBuilder.js";const s=8,c=16;function x(){const x=new t;x.include(e),x.fragment.uniforms.add(new r("edgesTexture",e=>e.inputTexture),new r("areaTexture",e=>e.areaTexture),new r("searchTexture",e=>e.searchTexture)),x.fragment.constants.add("smaaAreaTexPixelSize","vec2",[1/160,1/560]);const d=1/7;return x.fragment.code.add(o`
    ...
    vec2 getArea(sampler2D areaTex, vec2 dist, float e1, float e2, float offset) {
      ...
      texcoord.y += ${o.float(d)} * offset;
      return texture(areaTex, texcoord).rg;
    }`),x.fragment.main.add(o`
